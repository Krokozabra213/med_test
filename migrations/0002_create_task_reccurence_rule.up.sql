CREATE TABLE task_recurrence_rules (
    ...
    recurrence_type TEXT NOT NULL DEFAULT 'empty',
    settings JSONB NOT NULL,
    scheduled_time TIME NOT NULL,
    timezone TEXT NOT NULL,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()

    CONSTRAINT rules_recurrence_type_check
        CHECK (recurrence_type IN ('empty', 'daily', 'monthly_day', 'specific_dates', 'day_parity'))
);
